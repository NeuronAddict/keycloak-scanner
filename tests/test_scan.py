...
def test_full_scan(base_url: str, full_scan_mock_session: Session, monkeypatch):
    ...
    assert scanner.results.results == {
        ...
        'credential_dict': {'master-client1': Credential(Realm('master', 'http://localhost:8080/auth/realms/master',
                                                               {'realm': 'master',
                                                                ...
                                                                'tokens-not-before': 0}), Client('client1',
                                                                                                 ...
                                                                                                 ClientConfig('client1',
                                                                                                              'http://localhost:8080/realms/other/clients-registrations/default/client1',
                                                                                                              {
                                                                                                                  ...
                                                                                                                  'optionalClientScopes': [
                                                                                                                      ...
                                                                                                                      'microprofile-jwt']})),
                                                         'user', 'user'),
                            'master-client2': Credential(Realm('master', 'http://localhost:8080/auth/realms/master',
                                                               {'realm': 'master',
                                                                'public_key': '',
                                                                'token-service': 'http://localhost:8080/auth/realms/master/protocol/openid-connect',
                                                                'account-service': 'http://localhost:8080/auth/realms/master/account',
                                                                'tokens-not-before': 0}), Client('client2',
                                                                                                 'http://localhost:8080/auth/realms/other/client2',
                                                                                                 None, None), 'user',
                                                         'user'),
                            'other-client1': Credential(Realm('other', 'http://localhost:8080/auth/realms/other',
                                                              {'realm': 'other',
                                                               'public_key': '',
                                                                                                ...
                                                                                                ClientConfig('client1',
                                                                                                             'http://localhost:8080/realms/other/clients-registrations/default/client1',
                                                                                                             {
                                                                                                                 ...
                                                                                                                 'optionalClientScopes': [
                                                                                                                     ...
                                                                                                                     'microprofile-jwt']})),
                                                        'user', 'user'),
                            'other-client2': Credential(Realm('other', 'http://localhost:8080/auth/realms/other',
                                                              {'realm': 'other',
                                                               'public_key': '',
                                                               'token-service': 'http://localhost:8080/auth/realms/other/protocol/openid-connect',
                                                               'account-service': 'http://localhost:8080/auth/realms/other/account',
