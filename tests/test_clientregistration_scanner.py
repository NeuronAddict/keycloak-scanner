...
def test_client_registration_scanner_should_register_callback_list(master_realm: Realm, well_known_dict: WellKnownDict):
    ...
    scanner = TestClientRegistrationScanner(['http://callback', 'http://callback2'], base_url='http://localhost:8080', session_provider=session_provider)
